...
macro _sexpr {
  ...
  rule { (if $cond $sthen $selse) } => {
    (function () {
      if (_sexpr (.truthy (js global._oi_) $cond)) {
        return _sexpr $sthen;
      }
      return _sexpr $selse;
    }.call(this))
  ...
  rule { (cond $cond1 $body1 $rest ...) } => {
    (function () {
      if (_sexpr (.truthy (js global._oi_) $cond1)) {
        return _sexpr $body1;
      }
  ...
  rule { (and $sexpr) } => {
    _sexpr (.truthy (js global._oi_) $sexpr)
  }
  rule { (and $sexpr $sexprs ...) } => {
    _sexpr (.truthy (js global._oi_) $sexpr) && _sexpr (and $sexprs ...)
  }
  ...
  rule { (or $sexpr $sexprs ...) } => {
    _sexpr (.truthy (js global._oi_) $sexpr) || _sexpr (or $sexprs ...)
  }
  ...
  rule { (while $cond $sexpr) } => {
    (function () {
      while (_sexpr (.truthy (js global._oi_) $cond)) {
        _sexpr $sexpr;
      }
    }.call(this))
  }
